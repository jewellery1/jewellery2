...
// for data useradj
 if($scope.transaction =="Sale Returns" || $scope.transaction =="Urd Purchase" || $scope.transaction =="RD PURCHASE" || $scope.urd_amt !=null || $scope.book_amt != null|| $scope.sch_amt !=null){
    ...
    $scope.inoviceNumberGeneration= function(){
            //alert("inove generation")
          var customerDetails = $scope.transaction+","+$scope.partyname;
          // var user1 = JSON.parse(window.sessionStorage.getItem("userids"));

           // $http.get('/useritInvoice/'+customerDetails ).success(function(response){
           //           console.log(response.length)
           //           console.log(response)
           //          var useritInvoiceLength = response.length;
           //           for(let b =1;b<=useritInvoiceLength;b++){
           //           alert(response[b].voucherNo);
           //          //    // response[b].voucherNo
           //          //     $http.get('/useritInvoiceValue/'+customerDetails ).success(function(response){
           //          //         console.log(response)
           //          //         console.log(b)
           //          //         console.log(response[b].voucherNo)
           //          //     })
